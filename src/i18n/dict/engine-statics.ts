...
export default {
  ...
  'along the length (X)': { uk: 'уздовж довжини (X)', de: 'entlang der Länge (X)' },
  'across (Z)': { uk: 'впоперек (Z)', de: 'quer (Z)' },
  'along the length (X) and across (Z)': { uk: 'уздовж довжини (X) та впоперек (Z)', de: 'entlang der Länge (X) und quer (Z)' },
  '{combo} across (Z)': { uk: '{combo} впоперек (Z)', de: '{combo} quer (Z)' },
  '{combo} along the length (X)': { uk: '{combo} уздовж довжини (X)', de: '{combo} entlang der Länge (X)' },
  'front + rear': { uk: 'передню + задню', de: 'vordere + hintere' },
  'rear + front': { uk: 'задню + передню', de: 'hintere + vordere' },
  'left + right': { uk: 'ліву + праву', de: 'linke + rechte' },
  'right + left': { uk: 'праву + ліву', de: 'rechte + linke' },

  // ── Element names ─────────────────────────────────────────────────────────────────────
  Rafter: { uk: 'Кроква', de: 'Sparren' },
  'Purlin {side}': { uk: 'Прогон {side}', de: 'Pfette {side}' },
  'Purlin mid': { uk: 'Проміжний прогон', de: 'Mittelpfette' },
  'Post {side}': { uk: 'Стовп {side}', de: 'Pfosten {side}' },
  'Post mid': { uk: 'Стовп середній', de: 'Pfosten mitte' },
  'Knee braces {axis}': { uk: 'Підкоси {axis}', de: 'Kopfbänder {axis}' },
  'Sway posts {axis}': { uk: 'Консольні стовпи {axis}', de: 'Eingespannte Pfosten {axis}' },
  'Boarded wall {axis}': { uk: 'Обшита стіна {axis}', de: 'Wandscheibe {axis}' },
  'Roof uplift / anchoring': { uk: 'Відрив даху / кріплення', de: 'Abhebesicherung des Dachs' },
  ...
  'Header {opening} ({wall})': { uk: 'Перемичка {opening} ({wall})', de: 'Sturz {opening} ({wall})' },
  'Header ({wall})': { uk: 'Перемичка ({wall})', de: 'Sturz ({wall})' },
  ...
  level: { uk: 'горизонтально', de: 'eben' },
  sloped: { uk: 'похило', de: 'geneigt' },
  ...
  'With wind moment {list}.': { uk: 'З урахуванням вітрового моменту {list}.', de: 'Mit Windmoment {list}.' },
  'Governing {g}.': { uk: 'Визначальне {g}.', de: 'Maßgebend {g}.' },
  ...
  'Wind {axis}: W_k = {Wk} kN, H_d = {Hd} kN.': { uk: 'Вітер {axis}: W_k = {Wk} kN, H_d = {Hd} kN.', de: 'Wind {axis}: W_k = {Wk} kN, H_d = {Hd} kN.' },
  ...
  'Net {net} tension per post.': { uk: 'Чистий розтяг {net} на стовп.', de: 'Netto {net} Zug je Pfosten.' },
  ...
  'Rafters (Sparren)': { uk: 'Крокви (Sparren)', de: 'Sparren' },
  'Purlins (Pfetten)': { uk: 'Прогони (Pfetten)', de: 'Pfetten' },
  'Posts (Pfosten)': { uk: 'Стовпи (Pfosten)', de: 'Pfosten' },
  'Wall studs (Ständer)': { uk: 'Стійки стін (Ständer)', de: 'Wandständer' },
  'Knee braces (Kopfbänder)': { uk: 'Підкоси (Kopfbänder)', de: 'Kopfbänder' },
  'Knee braces enabled': { uk: 'Підкоси увімкнено', de: 'Kopfbänder aktiviert' },
  'Floor joists (Fußbodenbalken)': { uk: 'Лаги підлоги (Fußbodenbalken)', de: 'Fußbodenbalken' },
  'Floor bearers (Unterzüge)': { uk: 'Опорні балки підлоги (Unterzüge)', de: 'Unterzüge' },
  'Max floor bearer spacing': { uk: 'Макс. крок опорних балок підлоги', de: 'Max. Unterzugsabstand' },
  'Max floor support spacing': { uk: 'Макс. крок опор підлоги', de: 'Max. Stützenabstand (Boden)' },

  // ── materials.ts: roof covering names ─────────────────────────────────────────────────
  'Trapezoidal steel sheet': { uk: 'Профнастил', de: 'Trapezblech' },
  'Polycarbonate panels': { uk: 'Полікарбонатні панелі', de: 'Stegplatten' },
  'Bitumen shingles on OSB': { uk: 'Бітумна черепиця на ОСП', de: 'Bitumenschindeln auf OSB' },
  'Concrete / clay tiles': { uk: 'Бетонна / керамічна черепиця', de: 'Beton-/Tondachziegel' },
  'Extensive green roof': { uk: 'Екстенсивний зелений дах', de: 'Extensive Dachbegrünung' },
} satisfies Dict;
